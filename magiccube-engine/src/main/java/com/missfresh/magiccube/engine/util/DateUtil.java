...
public class DateUtil {
    ...
    public static String getAge(String myDate) throws ParseException {
        ...
        Date date = new Date();
        Date mydate = myFormatter.parse(myDate);
        // 算出总共多少天
    ...
    /**
     * @param date   要进行操作日期
     * @param field  Calendar类中的常量
     * @param amount 加减的数值,可以是负数
     * @return
    ...
    /**
     * @param lastIntoTime 新增进件进件日期
     * @param checkDate    指定的比较日期
     * @return 真/假
