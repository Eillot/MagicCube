package com.simon.magiccube.dao.config;


import com.simon.magiccube.engine.util.RedisUtil;
...
public class RedisConfig {
    ...
    /**
     @Bean public RedisSentinelConfiguration sentinelConfiguration(String hostName, int port, String senHost, int senPort) {
    ...
    /**
     @Bean public JedisConnectionFactory jedisConnectionFactory(JedisPoolConfig jedisPoolConfig, RedisSentinelConfiguration sentinelConfig) {
